...
public class OtherTests {
	...
	public static void testCunksUsedForConcepts() throws IOException {
		...
		FileWriter fw = new FileWriter(Util.CHUNKS_USED_FOR_MED_CONC, false);
		BufferedWriter bw = new BufferedWriter(fw);
		PrintWriter out = new PrintWriter(bw);
		
		//preluare Chunks in HashMap
		HashMap<String,Integer> hmap = new HashMap<String,Integer>();
		FileReader frchks = new FileReader(Util.CHUNKS_FILE);
		...
		while ((currentLine = br.readLine()) != null) {
			if (count > 0) {
				...
				if(!tokens[tokens.length - 1].equals("none") && !chnkOfTokens[0].equals("''") && !chnkOfTokens[0].equals(":")) {
	...
	public static void testCunksUsedForNonConcepts() throws IOException {
		...
		FileWriter fw = new FileWriter(Util.CHUNKS_USED_FOR_NONMED_CONC, false);
		BufferedWriter bw = new BufferedWriter(fw);
		PrintWriter out = new PrintWriter(bw);
	...
	public static void testNChunksUsedForNonConcepts(int n) throws IOException {
		...
		while ((currentLine = br.readLine()) != null) {
			if (count > 0) {
				...
				String[] chnkOfTokens = tokens[22].split("_");
				//System.out.println(posOfTokens[0]);
				if(chnkOfTokens.length >= n && tokens[tokens.length - 1].equals("none") && !chnkOfTokens[0].equals("''") && !chnkOfTokens[0].equals(":")) {
					String chnk = "";
					for(int k = 0; k < n; k++) {
						if(k == (n-1)) {
							chnk += chnkOfTokens[k];
	...
	public static void testNPOSUsedForNonConcepts(int n) throws IOException {
		...
		FileWriter fw = new FileWriter(Util.POS_USED_FOR_NONMEDICAL_CONCEPT, false);
		BufferedWriter bw = new BufferedWriter(fw);
		PrintWriter out = new PrintWriter(bw);
		...
		while ((currentLine = br.readLine()) != null) {
			if (count > 0) {
				...
				//System.out.println(posOfTokens[0]);
				if(posOfTokens.length >= n && tokens[tokens.length - 1].equals("none") && !posOfTokens[0].equals("''") && !posOfTokens[0].equals(":")) {
					String pos = "";
					for(int k = 0; k < n; k++) {
						if(k == (n-1)) {
							pos += posOfTokens[k];
	...
	public static void testNPOSUsedForConcepts(int n) throws IOException {
		...
		FileWriter fw = new FileWriter(Util.POS_USED_FOR_MEDICAL_CONCEPT, false);
		BufferedWriter bw = new BufferedWriter(fw);
		PrintWriter out = new PrintWriter(bw);
	...
	public static void testPOSUsedForConcepts() throws IOException {
		...
		//preluare POS in HashMap
		HashMap<String,Integer> hmap = new HashMap<String,Integer>();
		FileReader frPOS = new FileReader(Util.POS_FILE);
		...
		while ((currentLine = br.readLine()) != null) {
			if (count > 0) {
				...
				String[] posOfTokens = tokens[21].split("_");
				//System.out.println(posOfTokens[0]);
				if(!tokens[tokens.length - 1].equals("none") && !posOfTokens[0].equals("''") && !posOfTokens[0].equals(":")) {
