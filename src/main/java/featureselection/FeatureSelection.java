...
/**
 * Feature selection with Java ML
 * {warning} If the data set is too big throws garbage collector exception
 * it needs csv files or others. See {@link http://java-ml.sourceforge.net/}
 * 
 * @author Ariana
 *
 */
public class FeatureSelection {
	 ...
	 * @param n is number of features to take into account
	 * @param data is the file with features
	 */
	private static void getFirstNFeatures(int n, Dataset data) {
		...
		ga.build(data);
		System.out.println("First " + n + "features:");
